...
class BillingClient
{
    ...
    {
        $url = $this->billingUrl . '/api/v1/users/current';  // Endpoint для получения данных текущего пользователя
        ...
        if ($statusCode !== 200) {
            throw new BillingUnavailableException('Не удалось получить данные пользователя.');
        }
        ...
        return $responseData; // Возвращаем данные пользователя (email, роли, баланс)
    }
